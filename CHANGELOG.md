...
-   added `Hide Modifiers` setting: messages generated by non-player owned actors will see their modifiers tags hidden from players
    -   an also hide the traits tags on those same messages
